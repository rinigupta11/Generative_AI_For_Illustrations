...
The summarization worked just as I would want it to, but perhaps seeing how abstractive summarization works in comparison to extractive summarization would be a useful avenue to explore in the future. Furthermore, doing some more extensive and robust testing about the optimal number of sentences would add validity to the results I obtained. Doing so would be challenging, but even expanding the dataset to include a variety of novels would improve our understanding of the best practices.
